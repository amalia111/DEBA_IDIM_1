...
--
-- Host: localhost:3306
-- Waktu pembuatan: 06 Bulan Mei 2023 pada 17.16
-- Versi server: 8.0.30
-- Versi PHP: 8.1.10
...
INSERT INTO `barang` (`IdBarang`, `NamaBarang`, `Keterangan`, `satuan`, `IdPengguna`, `supplier_id`) VALUES
(1, 'Lemari 1234', 'Lemari 2 tingkat', 'pcs', 1, NULL),
(2, 'Lemari Baju', 'Lemari Baju \r\nGantung', 'Buah', 1, NULL),
(3, 'Meja Kaki 1', 'Meja Kaki 1', 'Buah', 1, NULL),
(4, 'Pakaian T-Shirt', 'Baju santai', 'Potong', 1, NULL),
(5, 'Meja Kaki 4', 'Meja Kaki 4', 'Buah', 1, NULL),
(6, 'lemari sepatu', 'lemari sepatu 3 tingkat', 'pcs', 2, NULL);
...
(1, 'fachry_53', 'test', 'Fachry Azri', 'Arrasyid', '081298863013', 'Jalan Kenangan', 5),
(2, 'adam51', 'test1', 'Adam', 'Nurjanah', '081298873232', 'Jalan-jalan', 2),
(3, 'nani51', 'test2', 'Nani', 'Nurjanah', '081298873232', 'Jalan-jalan', 3);
...
INSERT INTO `penjualan` (`IdPenjualan`, `JumlahPenjualan`, `HargaJual`, `IdBarang`, `id_pelanggan`) VALUES
(1, 2, 220000, 1, NULL),
(2, 1, 400000, 3, NULL),
(3, 2, 130000, 4, NULL),
(4, 4, 300000, 1, NULL),
...
--
ALTER TABLE `hakakses`
  MODIFY `IdAkses` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT untuk tabel `pembelian`
--
ALTER TABLE `pembelian`
  MODIFY `IdPembelian` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `penjualan`
  MODIFY `IdPenjualan` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
ALTER TABLE `barang`
  ...
  ADD CONSTRAINT `barang_ibfk_2` FOREIGN KEY (`supplier_id`) REFERENCES `supplier` (`IdSupplier`);
...
ALTER TABLE `penjualan`
  ...
  ADD CONSTRAINT `penjualan_ibfk_2` FOREIGN KEY (`id_pelanggan`) REFERENCES `pelanggan` (`IdPelanggan`);
COMMIT;
